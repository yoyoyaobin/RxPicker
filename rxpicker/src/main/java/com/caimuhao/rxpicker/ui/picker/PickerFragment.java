...
public class PickerFragment extends AbstractFragment<PickerFragmentPresenter>
    ...
    private void initView(View view) {
        ...
        rlBottom.setBackgroundResource(config.getBackgroundColor());
    ...
    private void initTopView(View view){
        ...
        llTop.setBackgroundResource(config.getBackgroundColor());
    ...
    private void selectSuccess() {
        ...
        Set<ImageItem> imageItemSet = new HashSet<>();
        imageItemSet.addAll(checkImage);
        checkImage.clear();
        checkImage.addAll(imageItemSet);
