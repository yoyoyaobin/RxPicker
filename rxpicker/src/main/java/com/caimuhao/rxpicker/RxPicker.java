...
public class RxPicker {
     ...
     * @return
     */
    public RxPicker backgroundColor(int color) {
        RxPickerManager.getInstance().backgroundColor(color);
        return this;
    }
     ...
     * @return
     */
    public RxPicker checkBoxColor(int color) {
        RxPickerManager.getInstance().checkBoxColor(color);
        return this;
    }
